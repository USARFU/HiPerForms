...
define( 'YOURLS_DB_USER', 'c41yourls' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'ClaW4dcfkRY@C' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'c41yourls' );
...
define( 'YOURLS_SITE', 'http://hiperforms.com/y' );
...
define( 'YOURLS_COOKIEKEY', '$#hwyJGqg}FR4-_D&_qbFN4_aYBntBdzc&MUF' );
